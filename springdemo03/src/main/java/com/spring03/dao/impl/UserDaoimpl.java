package com.spring03.dao.impl;

import com.spring03.dao.UserDao;
import com.spring03.service.impl.UserServiceimpl;
import com.spring03.user.user;
...
public class UserDaoimpl implements UserDao {
    // 驱动包名和数据库url
    private static String url ="jdbc:mysql://localhost:3306/web_jsp?serverTimezone=Hongkong&useUnicode=true&characterEncoding=utf8&useSSL=false";
    ...
    public static int login(String uname, String passwd) {
...
public static ArrayList getuser()throws Exception
{
    ...
    public static void main(String[] args) throws Exception {
       ...
       /* for(int i=0;i<users.size();i++)
        ...
        System.out.println("ceshi"+ UserServiceimpl.login(username,password));
